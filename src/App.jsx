...
const CONTRACT_ADDRESS = "0xD64a289eD6F5D93aE622Ad39D12C172F432244F7";
...
export function App(props) {
  ...
  return (
    <Container fluid style={{ width: "98%", padding: "0px", border: "1px solid black", maxHeight:"100vh" }}>
      ...
      <Row>
        ...
        <Col style={{ paddingRight: "0px", borderRight: "2px solid #000000", height: "93vh" }}>
          <div
            style={{
        ...
        <Col xs={8} style={{ paddingLeft: "0px" }}>
          <div style={{ backgroundColor: "#DCDCDC", height: "93vh" }}>
